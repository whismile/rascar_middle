...
class Rear_Wheels(object):
    ...
    def go_forward(self, speed_value: int):
    ...
    def go_backward(self, speed_value: int):
    ...
    @property
    def _get_cali_forward_A(self) -> int:
        """ Return forward_A variables """
        return self.cali_forward_A

    @property
    def _get_cali_forward_B(self) -> int:
